...
#define ICON_PATH		@"/Library/WeeLoader/Plugins/NCMeters.bundle/"
...
@interface NCMetersMeterList : PSViewController <UITableViewDelegate, UITableViewDataSource>
...
@implementation NCMetersMeterList
...
- (void)syncPrefs:(BOOL)notificate {
	...
	if (notificate) {
		CFNotificationCenterPostNotification(CFNotificationCenterGetDarwinNotifyCenter(),
											 CFSTR("com.sticktron.ncmeters.settings-changed"),
											 NULL, NULL, YES);
	}
}
