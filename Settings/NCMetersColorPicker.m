...
static CFStringRef const kPrefsNotification = CFSTR("com.sticktron.ncmeters.settings-changed");
...
@interface NCMetersColorPicker : PSViewController <UITableViewDataSource, UITableViewDelegate>
...
@implementation NCMetersColorPicker
